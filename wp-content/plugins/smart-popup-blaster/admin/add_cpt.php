...
function trigger_box($object){
    ...
    <table>
      ...
      <tr>
      <td colspan="5"><span id="click-help" style="background-color:#F1F1F1;padding:4px;<?php if ($popup_trigger !== 'none'){echo 'display:none;';} ?>"><small>For details how to use click trigger check help page.</small></span></td>
      </tr> 
      <td>Exit Intent: </td>
